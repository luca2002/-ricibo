...
<?php	// X I VOLONTARI NON VIENE RICHIESTO
		...
		if (isset($_SESSION['FLAG_PERSONA'])) {
...
?>
		...
		<div class="input-field col s12">
			...
			<input type="date" name="DATA_NASCITA" class="datepicker"<?php echo(" value=\"$DATA_NASCITA\""); ?>>
		...
		<div class="input-field col s12">
			...
			<label for="icon_prefix">Provincia domicilio (sigla di 2 lettere)</label>
		</div>
		<div class="input-field col s12">
			<i class="material-icons prefix">location_on</i>
		...
		<div class="input-field col s12">
			...
			<label for="icon_telephone">Cellulare (necessario per far dialogare sito, DB e app)</label>
		</div>
		</center>
		<br>
