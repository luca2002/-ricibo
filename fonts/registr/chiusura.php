...
<div class="container"><a href="/~ricibo/index.php" id="logo-container" class="brand-logo"><img src="<?php echo $_SESSION['PATH'];?>/img/logo-trasparente.jpg"></a></div><ul class="right hide-on-med-and-down"><li><a href="/~ricibo/index.php">Home</a></li><li><a href="/~ricibo/chisiamo.php">Chi siamo</a></li><li><a href="/~ricibo/cosafacciamo.php">Cosa Facciamo</a></li><li><a href="/~ricibo/mappa.php">Mappa Del Sito</a></li><li><a href="/~ricibo/contattaci.php">Contattaci</a></li><li><a href="/~ricibo/login.php">Login</a></li>	</ul>
